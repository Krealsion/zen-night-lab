// Farrow — BLUE-1, Blue crew leader.
//
// Twenty-two years in, and the most economical breather at the station. Farrow
// works in the passage with the jet while Teague goes in behind the racking,
// and answers every check with the flatness of somebody who has done this a
// great many times.
//
// The interesting thing about Farrow is what they DO NOT do: Farrow never
// reaches turn-around pressure in this incident, so nothing about Farrow is
// ever decided by Farrow. Every decision about Farrow is the board's. That is
// what a well-run wear looks like and it is why it is worth having one in the
// room.
...
private:
    static const char* role() { return "wearer.blue-1"; }
