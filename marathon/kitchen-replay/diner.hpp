#ifndef MARATHON_KITCHEN_DINER_HPP
#define MARATHON_KITCHEN_DINER_HPP
...
/// The diner's outstanding orders and its transcript. Owned by the HOST, so a
/// test or a demo can place orders as this weave and read back exactly what it
/// heard.
struct DinerBook {
...
#endif // MARATHON_KITCHEN_DINER_HPP
